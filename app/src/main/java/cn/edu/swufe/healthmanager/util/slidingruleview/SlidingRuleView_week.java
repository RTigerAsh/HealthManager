...
public class SlidingRuleView_week extends View {
    ...
    public SlidingRuleView_week(Context context) {
        this(context,null);

    }

    public SlidingRuleView_week(Context context, AttributeSet attrs) {
        this(context, attrs,0);
    }


    public SlidingRuleView_week(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        //刻度大数目 默认30
        lineCount = typedArray.getInt(R.styleable.SlidingRuleView_Kg_lineCount, 30);
        //长的刻度线条长度
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawText("week", greenPointX + textWidth / 2 + getScrollX() + SystemUtil.dp2px(getContext(),3), topDegreeLine - SystemUtil.dp2px(getContext(),30), paint);
    }
