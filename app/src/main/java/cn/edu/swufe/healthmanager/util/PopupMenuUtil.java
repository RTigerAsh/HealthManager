...
public class PopupMenuUtil {
    ...
    private LinearLayout llTest1, llTest2, llTest5, llTest6, llTest7, llTest8;
    ...
    private void initLayout(Context context) {
        ...
        llTest1 = (LinearLayout) rootVew.findViewById(R.id.ic_daka);
        llTest2 = (LinearLayout) rootVew.findViewById(R.id.ic_question);
        llTest5 = (LinearLayout) rootVew.findViewById(R.id.ic_sport);
        llTest6 = (LinearLayout) rootVew.findViewById(R.id.ic_food);
        llTest7 = (LinearLayout) rootVew.findViewById(R.id.ic_tz);
        llTest8 = (LinearLayout) rootVew.findViewById(R.id.ic_sleep);
