...
public class SlidingRuleView_Kg extends View {
    ...
    public SlidingRuleView_Kg(Context context) {
        this(context,null);

    }

    public SlidingRuleView_Kg(Context context, AttributeSet attrs) {
        this(context, attrs,0);
    }


    public SlidingRuleView_Kg(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        //刻度大数目 默认60
        lineCount = typedArray.getInt(R.styleable.SlidingRuleView_Kg_lineCount, 100);
        //长的刻度线条长度
